...
<body>
    <form action="<%=basePath %>cms/op/upload" enctype="multipart/form-data" method="post">
        <div>
            <input type="text" readonly="readonly" /> 
            <a href="javascript:void(0);" class="input"> 
                浏览 <input type="file" class="file" name="uploadfile">
            </a>
        </div>
    ...
    <br />
    <a href="<%=basePath %>cms/list">下载文件</a>
